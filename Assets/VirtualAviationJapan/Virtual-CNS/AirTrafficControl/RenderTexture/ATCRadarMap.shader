...
Shader "Custom/ATCRaderMap"
{
	Properties
	{
		...
		_LineContrast("Line Contrast", Float) = 32
	...
	SubShader
	{
		...
		{
			float temp_output_21_0 = ( 1.0 / _LineContrast );
			float2 uv_MainTex = i.uv_texcoord * _MainTex_ST.xy + _MainTex_ST.zw;
			float smoothstepResult18 = smoothstep( ( temp_output_21_0 * ( 1.0 - _LineWidth ) ) , temp_output_21_0 , saturate( ( abs( ( tex2D( _MainTex, ( ( float2( 1,1 ) * (_MainTex_TexelSize).xy ) + uv_MainTex ) ).r - tex2D( _MainTex, ( ( float2( 0,1 ) * (_MainTex_TexelSize).xy ) + uv_MainTex ) ).r ) ) + abs( ( tex2D( _MainTex, ( ( float2( 1,0 ) * (_MainTex_TexelSize).xy ) + uv_MainTex ) ).r - tex2D( _MainTex, ( ( float2( 0,0 ) * (_MainTex_TexelSize).xy ) + uv_MainTex ) ).r ) ) ) ));
...
/*ASEBEGIN
Version=18921
0;1000;1766;1079;1497.492;332.7448;1;True;False
...
Node;AmplifyShaderEditor.RelayNode;59;-2602.105,-451.6648;Inherit;False;1;0;FLOAT2;0,0;False;1;FLOAT2;0
Node;AmplifyShaderEditor.Vector2Node;42;-2788.139,9.005466;Inherit;False;Constant;_Vector3;Vector 3;5;0;Create;True;0;0;0;False;0;False;1,0;0,0;0;3;FLOAT2;0;FLOAT;1;FLOAT;2
Node;AmplifyShaderEditor.Vector2Node;41;-2788.139,137.0055;Inherit;False;Constant;_Vector2;Vector 2;5;0;Create;True;0;0;0;False;0;False;0,0;0,0;0;3;FLOAT2;0;FLOAT;1;FLOAT;2
Node;AmplifyShaderEditor.Vector2Node;39;-2788.139,-246.9945;Inherit;False;Constant;_Vector0;Vector 0;5;0;Create;True;0;0;0;False;0;False;1,1;0,0;0;3;FLOAT2;0;FLOAT;1;FLOAT;2
Node;AmplifyShaderEditor.Vector2Node;40;-2788.139,-118.9945;Inherit;False;Constant;_Vector1;Vector 1;5;0;Create;True;0;0;0;False;0;False;0,1;0,0;0;3;FLOAT2;0;FLOAT;1;FLOAT;2
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;45;-2542.139,-311.9945;Inherit;False;2;2;0;FLOAT2;0,0;False;1;FLOAT2;0,0;False;1;FLOAT2;0
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;47;-2564.139,9.005466;Inherit;False;2;2;0;FLOAT2;0,0;False;1;FLOAT2;0,0;False;1;FLOAT2;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;46;-2548.139,-118.9945;Inherit;False;2;2;0;FLOAT2;0,0;False;1;FLOAT2;0,0;False;1;FLOAT2;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;48;-2564.139,137.0055;Inherit;False;2;2;0;FLOAT2;0,0;False;1;FLOAT2;0,0;False;1;FLOAT2;0
...
Node;AmplifyShaderEditor.SimpleAddOpNode;63;-2335.617,-119.2694;Inherit;False;2;2;0;FLOAT2;0,0;False;1;FLOAT2;0,0;False;1;FLOAT2;0
...
Node;AmplifyShaderEditor.RangedFloatNode;28;-1153.601,757.2359;Inherit;False;Property;_LineWidth;Line Width;2;0;Create;True;0;0;0;False;0;False;1;0.4;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.AbsOpNode;56;-1664,0;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.AbsOpNode;55;-1664,-112;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;19;-1690.109,511.111;Inherit;False;Property;_LineContrast;Line Contrast;1;0;Create;True;0;0;0;False;0;False;32;150;0;0;0;1;FLOAT;0
...
ASEEND*/
//CHKSM=DEDC1F08C5104158166F546AE52A2E0F512C9935